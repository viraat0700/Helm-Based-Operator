...
# example.com/wordpress-helm-operator-bundle:$VERSION and example.com/wordpress-helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/wordpress-helm-operator
